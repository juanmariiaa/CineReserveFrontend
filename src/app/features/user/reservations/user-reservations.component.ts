...
export class UserReservationsComponent implements OnInit {
  ...
  getReservationTotal(reservation: any): number {
    return (
      reservation.seatReservations.length * reservation.screening.ticketPrice
    );
  }
  ...
  getTodayReservations(): any[] {
    return this.reservations.filter((r) =>
      this.isTodayReservation(r.screening.startTime)
    );
  }

  getUpcomingReservations(): any[] {
    return this.reservations.filter((r) =>
      this.isUpcoming(r.screening.startTime)
    );
  }

  getPastReservations(): any[] {
    return this.reservations.filter((r) =>
      this.isPastReservation(r.screening.startTime)
    );
  }
